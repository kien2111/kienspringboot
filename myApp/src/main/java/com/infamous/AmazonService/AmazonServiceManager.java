...
public class AmazonServiceManager {
	private static final String KEYID = "AKIAIQWYBV35B7UBGC2A";
	private static final String ACCESSID = "YVsX0y7GGKY7MV2YQqlnGt81SH29/4PdmTbQzhh4";
	private static final String REGION = "us-east-2";
	private static final String BUCKET = "nhom9testbucket";
